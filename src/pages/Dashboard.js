...
import imgPattern6 from '../assets/images/pattern/pattern6.png';
import imgCircle from '../assets/images/pattern/circle.png';
import imgPic1 from '../assets/images/profile/small/pic1.jpg';
...
import imgAvatar6 from '../assets/images/avatar/6.jpg';
         ...
         <div className="row">
                 ...
                 <div className="row align-items-center">
                   <div className="col-xl-6">
                     <div className="card-bx bg-blue">
                       <img className="pattern-img" src={imgPattern6} alt="" />
                       <div className="card-info text-white">
                         <img src={imgCircle} className="mb-4" alt="" />
                     ...
                     <div className="row  mt-xl-0 mt-4">
                       <div className="col-md-6">
                         ...
                         <ul className="card-list mt-4">
                           <li>
                             <span className="bg-blue circle"></span>Account
                             <span>20%</span>
                           </li>
                           <li>
                             <span className="bg-success circle"></span>Services
                             <span>40%</span>
                           </li>
                           <li>
                           ...
                           <li>
                             <span className="bg-light circle"></span>Others
                             <span>15%</span>
                           </li>
                         </ul>
                       </div>
               ...
               <div className="card-header pb-0 border-0">
                 ...
                 <ul className="card-list">
                   <li className="justify-content-end">
                     Income<span className="bg-success circle me-0 ms-2"></span>
                   </li>
                   <li className="justify-content-end">
                     Outcome<span className="bg-danger circle me-0 ms-2"></span>
                   </li>
                 </ul>
               </div>
           ...
           <div className="col-xl-3 col-xxl-5">
             <div className="card">
               ...
               <div className="card-footer border-0 pt-0">
                 <a href="#" className="btn btn-outline-primary d-block btn-lg">
                   View More
                 </a>
               </div>
             </div>
           ...
           <div className="col-xl-6 col-xxl-7">
             <div className="card">
               <div className="card-header d-flex flex-wrap border-0 pb-0">
                 ...
                 <a
                   href="#"
                   className="btn btn-rounded btn-md btn-primary me-3 me-3"
                 >
                   <i className="las la-download scale5 me-3"></i>Download
                   Report
                 </a>
                 <div className="dropdown">
                   <a
               ...
               <div className="card-body pb-2">
                 <div className="d-sm-flex d-block">
                   ...
                   <ul className="card-list d-flex mt-sm-0 mt-3">
                     <li className="me-3">
                       <span className="bg-success circle"></span>Income
                     </li>
                     <li>
                       <span className="bg-danger circle"></span>Outcome
                     </li>
                   </ul>
                 </div>
