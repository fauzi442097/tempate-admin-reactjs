...
import profilePicture from '../../assets/images/profile/pic1.jpg'
                    ...
                    <div className="collapse navbar-collapse justify-content-between">
                        ...
                        <ul className="navbar-nav header-right">
                          ...
                          <li className="nav-item dropdown notification_dropdown">
                            ...
                            <div className="dropdown-menu dropdown-menu-end">
                                <div id="dlab_W_Notification1" className="widget-media dlab-scroll p-3" style={{ 
                                  height: '380px'
                                  }}>
                                  <ul className="timeline">
                                    <li>
                          ...
                          <li className="nav-item dropdown header-profile">
                              <a className="nav-link d-flex flex-wrap" href={undefined} role="button" data-bs-toggle="dropdown"
                                style={{ 
                                  borderRadius: '1.125rem'
                                }}>
                                <img src={profilePicture} width="50" alt="" />
                                <div className="header-info ms-3 d-sm-inline-block d-none">
                                    <span className="font-w600 "> <h6 className='mb-0'>Hi,<b>William</b> </h6> </span>
